    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vertical_spacing', enumfields.fields.EnumField(default='small', enum=backend.plugins.card_hero_with_content.models.VerticalSpacing, max_length=32)),
                ...
                ('hero_element_size', enumfields.fields.EnumField(default='normal', enum=backend.plugins.card_hero_with_content.models.HeroElementSize, max_length=32)),
            ],
            options={
                'abstract': False,
            },
